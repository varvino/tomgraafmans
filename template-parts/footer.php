        ...
        <div class="container">
            <div class="social__icons">
                <a href="https://www.linkedin.com" class="social__icon">
                    <img src="<?php echo get_theme_file_uri('/assets/img/icons/brand/linkedin.svg') ?>" alt="Deze link leidt naar mijn persoonlijke LinkedIn-pagina." class="social__icon-image">
                </a>
                <a href="https://www.github.com" class="social__icon">
                    <img src="<?php echo get_theme_file_uri('/assets/img/icons/brand/github.svg') ?>" alt="Op mijn Github heeft u inzicht in hoe ik mijn thema's opzet." class="social__icon-image">
                </a>
                <a href="<?php echo site_url('contact-details') ?>" class="social__icon">
                    <img src="<?php echo get_theme_file_uri('/assets/img/icons/brand/file-text.svg') ?>" alt="Wilt u graag snel contact opnemen? Dat kan! Op deze pagina vindt u mijn contactgevens." class="social__icon-image">
                </a>
            </div>
        </div>
    </div>
