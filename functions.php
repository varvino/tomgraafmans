...
function custom_breadcrumbs()
{
    ...
    $home_title = 'Homepage';
    $home_icon = '<span class="dashicons dashicons-admin-home"></span>';
    ...
    if (!is_front_page()) {
        ...
        // Home page
        echo '<li class="item--home"><a class="breadcrumb--home" href="' . get_home_url() . '" title="' . $home_title . '">' . $home_icon . '</a></li>';
